...
if __name__=='__main__':
    ...
    mode = 'text'
    image_root_path = '/mnt/xcp/self_training_only_img_or_text/rel_only_{}'.format(mode)
    save_root_path = '/mnt/xcp/self_training_only_img_or_text/rel_only_{}_features_img'.format(mode)
