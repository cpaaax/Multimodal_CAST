...
if __name__=='__main__':
    ...
    mode = 'img'
    image_root_path = '/mnt/xcp/self_training_only_img_or_text/sarcasm_only_{}'.format(mode)
    save_root_path = '/mnt/xcp/self_training_only_img_or_text/sarcasm_only_{}_features_img'.format(mode)
