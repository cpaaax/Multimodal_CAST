...
def Encoder(my_resnet, img_path):
    ...
    I = preprocess(I)
    with torch.no_grad():
        tmp_fc, tmp_att = my_resnet(I, att_size=5)
...
def multi_process(image_root_path, save_root_path,max_process):
    ...
    imgs = [os.path.join(image_root_path, img) for img in imgs_new]
...
if __name__=='__main__':
    ...
    # image_root_path = '/mnt/xcp/sentiment_imgs/MVSA_data/MVSA-single_data/MVSA-single_img_data'
    # save_root_path = '/mnt/xcp/sentiment_features/MVSA-single_data/extract_features_resnet152'

    image_root_path = '/mnt/xcp/sentiment_imgs/MVSA_data/MVSA-single_data/self_train_imgs/MVSA_single'
    save_root_path = '/mnt/xcp/sentiment_features/MVSA-single_data/extract_features_resnet152_10'
