...
if __name__=='__main__':
    ...
    image_root_path_ce = '/media/pc/Disk_8T/EMNLP_code/img_text_rel/filter_imgs'
    save_root_path_ce = '/media/pc/Disk_8T/EMNLP_code/img_text_rel/img_features'

    image_root_path_st = '/media/pc/Disk_8T/EMNLP_code/self_training_imgs_all/rel'
    save_root_path_st = '/media/pc/Disk_8T/EMNLP_code/img_text_rel/self_img_features_3'



    max_process = 4
    multi_process(image_root_path_ce, save_root_path_ce, max_process)
    multi_process(image_root_path_st, save_root_path_st, max_process)
